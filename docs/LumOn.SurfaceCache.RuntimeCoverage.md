...
| Common shader normal/material/color/depth helpers | Production `GBufferTextures` or centralized engine input owner; aliases may be disposed early by an individual test and companion ownership is cleaned at fixture teardown. No replicated production formats in these helpers. |
