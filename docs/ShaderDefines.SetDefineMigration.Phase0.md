...
- **LumOn combine** (`LumOnCombineShaderProgram` → `lumon_combine.*`): `lumOnEnabled`, `enablePbrComposite`, `enableAO`, `enableShortRangeAO` (GLSL `enableBentNormal`), plus intensity/tint and matrices.
