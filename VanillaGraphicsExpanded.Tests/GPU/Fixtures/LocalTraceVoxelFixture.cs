...
internal sealed class LocalTraceVoxelFixture : IDisposable
{
    ...
    private readonly LocalTraceVoxelProvider provider;
    private long tick;
    ...
    public LocalTraceVoxelFixture(VectorInt3 center = default, int resolution = 64)
    {
        ...
        provider = new LocalTraceVoxelProvider(Scene, materials);
    ...
    private void PublishCells(Func<(int X, int Y, int Z), LocalTraceSourceCell> capture)
    {
