...
/// <summary>Local geometry and integer-coordinate controls.</summary>
public sealed partial class LumOnLocalTraceFunctionalTests
{
    ...
    public void LargeWorldCoordinates_RetainSealedRoomOcclusion(int offset)
    {
        ...
        using var fixture = new LocalTraceVoxelFixture(origin);
        fixture.Publish(world);
    ...
    /// <summary>An initial solid is an immediate local hit rather than a clear ray into the cache.</summary>
    [Fact]
    ...
    /// <summary>Premature local-window exit cannot shorten the required segment and authorize cached light.</summary>
    [Fact]
