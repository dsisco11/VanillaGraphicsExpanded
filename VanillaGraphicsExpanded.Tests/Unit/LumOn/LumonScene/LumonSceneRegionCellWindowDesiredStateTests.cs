...
public sealed class LumonSceneRegionCellWindowDesiredStateTests
{
    [Fact]
    public void DesiredState_IsLoadedInsideLoadedWindowButOutsideActiveWindow()
    {
        ...
        var ctx = new WorldCellStateTransitionContext(
            ...
            LoadedWindowMaxRegion: new VectorInt3(4, 0, 4),
            HasLoadedWindow: true,
            ActiveWindowMinRegion: new VectorInt3(0, 0, 0),
            ActiveWindowMaxRegion: new VectorInt3(2, 0, 2),
    ...
    [Fact]
    public void DesiredState_IsUnloadedOutsideLoadedWindow()
    {
        var cell = new LumonSceneRegionCell(
            kind: WorldCellKind.LumonSceneNear,
