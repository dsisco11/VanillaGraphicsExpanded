...
public sealed class LocalTraceCoveragePolicyTests
{
    ...
    {
        var policy=new LocalTraceCoveragePolicy();
    ...
    public void UnsupportedEnvelopeIsRejected()
    {
        ...
        Assert.False(new LocalTraceCoveragePolicy(MaximumResolution:32).TryPlan(new(),20,out _));
    }
    ...
    {
        Assert.Equal(2*Math.Sqrt(3)*8*4,LocalTraceCoveragePolicy.MaximumTraceReach(20,8,3));
        Assert.Equal(200,LocalTraceCoveragePolicy.MaximumTraceReach(200,8,3));
    }
    #endregion
}
