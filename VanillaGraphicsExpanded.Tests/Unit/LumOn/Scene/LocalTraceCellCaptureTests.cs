...
public sealed class LocalTraceCellCaptureTests
{
    ...
    public void DarkAir_IsKnownEmpty()
    {
        ...
        var result = LocalTraceCellCapture.Capture(ControlledBlockAccessor.Create(world),
            new Block { BlockId = 0 }, new BlockPos(0), new LocalTraceMaterialRegistry());
    ...
    public void OpaqueCube_WithoutMaterial_RemainsOpaque()
    {
        ...
        var result = LocalTraceCellCapture.Capture(ControlledBlockAccessor.Create(world),
            cube, new BlockPos(0), new LocalTraceMaterialRegistry());
    ...
    public void UnsupportedGeometry_IsUnavailable(int variant)
    {
        ...
        var result = LocalTraceCellCapture.Capture(ControlledBlockAccessor.Create(world),
            block, new BlockPos(0), new LocalTraceMaterialRegistry());
