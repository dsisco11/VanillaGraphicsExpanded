...
/// <summary>Checks the expanded local tracing shader contract without a graphics context.</summary>
public sealed class LocalTraceUboTests
{
    ...
    {
        using var ubo=new LumOnLocalTraceParamsUbo();
        ...
        Assert.Equal(64,ubo.Bytes.Length);
