...
/** Implements render lumon scene patch uv debug for its explicit view entrypoint. */
...
/** Renders only the LumonScenePatchUv view; mode selection occurs before program loading. */
void main()
{
    uv = gl_FragCoord.xy / screenSize;
    vec2 screenPos = uv * screenSize;
    outColor = renderLumonScenePatchUvDebug();
}
