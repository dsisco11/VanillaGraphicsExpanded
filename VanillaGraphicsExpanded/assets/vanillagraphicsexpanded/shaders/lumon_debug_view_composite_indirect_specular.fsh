...
/** Implements render composite indirect specular debug for its explicit view entrypoint. */
...
/** Renders only the CompositeIndirectSpecular view; mode selection occurs before program loading. */
void main()
{
