...
internal interface ILocalTracePublicationBackend
{
    ...
    bool PublishCell(PartitionRequest request, ReadOnlySpan<LocalTraceSourceCell> cells, LocalTraceMaterialRegistry materials);
